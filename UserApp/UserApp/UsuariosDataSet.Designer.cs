...
namespace UserApp {
    ...
    public partial class UsuariosDataSet : global::System.Data.DataSet {
        ...
        public partial class UsuarioDataTable : global::System.Data.TypedTableBase<UsuarioRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public UsuarioRow AddUsuarioRow(string Email, string Endereco, string Nome, string Senha, string Telefone) {
...
namespace UserApp.UsuariosDataSetTableAdapters {
    ...
    public partial class UsuarioTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Usuario] ([Email], [Endereco], [Nome], [Senha], [Telefone]) VA" +
                "LUES (@Email, @Endereco, @Nome, @Senha, @Telefone);\r\nSELECT ID, Email, Endereco," +
                " Nome, Senha, Telefone FROM Usuario WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Usuario] SET [Email] = @Email, [Endereco] = @Endereco, [Nome] = @No" +
                "me, [Senha] = @Senha, [Telefone] = @Telefone WHERE (([ID] = @Original_ID));\r\nSEL" +
                "ECT ID, Email, Endereco, Nome, Senha, Telefone FROM Usuario WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::UserApp.Properties.Settings.Default.UsuariosConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Email, Endereco, Nome, Senha, Telefone FROM dbo.Usuario";
        ...
        public virtual int Insert(string Email, string Endereco, string Nome, string Senha, string Telefone) {
            if ((Email == null)) {
        ...
        public virtual int Update(string Email, string Endereco, string Nome, string Senha, string Telefone, int Original_ID, int ID) {
            if ((Email == null)) {
                throw new global::System.ArgumentNullException("Email");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Email, string Endereco, string Nome, string Senha, string Telefone, int Original_ID) {
            return this.Update(Email, Endereco, Nome, Senha, Telefone, Original_ID, Original_ID);
        }
    }
